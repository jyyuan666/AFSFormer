...
class Decoder(nn.Module):
    def __init__(self,
        ...
        self.p2 = FeatureFuse(in_channels=encoder_channels[-2], out_channels=decoder_channels)
        self.b2 = Block(in_dim=decoder_channels, num_heads=16, window_size=8)

        self.p3 = FeatureFuse(in_channels=encoder_channels[-3], out_channels=decoder_channels)
