    ...
    for epoch in range(epochs):
        ...
        for batch_idx, (x, y) in enumerate(train_dataloader):
            ...
            print(
                ...
                f'train {{ loss: {running_train_loss / batch_steps:.4g} -',
                f'MPA: {running_train_mpa * 100. / batch_steps:.4g}% -',
                f'MiOU: {running_train_miou * 100. / batch_steps:.4g}% }} -',
            ...
            if batch_steps % validation_step == 0:
                ...
                print(
                    ...
                    f'MPA: {val_mpa * 100:.4g}% -',
                    f'MiOU: {val_miou * 100:.4g}% }} -',
        ...
        print(
            ...
            f'MPA: {train_mpa * 100:.4g}% -',
            f'MiOU: {train_miou * 100:.4g}% }} -',
